...
public class DatabaseManipulation implements DataManipulation {
    ...
    private String dbname = "comparison";
    ...
    public int addAuthorArticles(String str){
        int result = 0;
        String sql = "insert into author_articles (author_id, article_id) " +
                "values (?,?) ON CONFLICT DO NOTHING";
        String Info[] = str.split("%%%");
        try {
            PreparedStatement preparedStatement = con.prepareStatement(sql);
    ...
    public int addArticleJournals(String str){
        int result = 0;
        String sql = "insert into article_journals (article_id, journal_id) " +
                "values (?,?) ON CONFLICT DO NOTHING";
        String Info[] = str.split("%%%");
        try {
            PreparedStatement preparedStatement = con.prepareStatement(sql);
    ...
    public int addAffiliation(String str) {
        //getConnection();
        int result = 0;
        String sql = "insert into affiliations (author_id,affiliation) " +
                "values (?,?) ON CONFLICT DO NOTHING";
        String Info[] = str.split(";");
        try {
            PreparedStatement preparedStatement = con.prepareStatement(sql);
    ...
    public int add_author_affiliations(String lastName,String affiliation) {
        ...
        try {
            PreparedStatement preparedStatement = con.prepareStatement(sql);
            preparedStatement.setInt(1, getAuthorId(lastName.replace("'","''")));
